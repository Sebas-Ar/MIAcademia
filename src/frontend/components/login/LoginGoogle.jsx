...
const LoginGoogle = ({
    ...
    const signInWithGoogle = async () => {
        triggerEvent(eventCategories.GENERAL_INTERACTIONS, eventNames.LOGIN_ATTEMPT, {
            type: 'google',
            locationBtn
        })
        signIn('google')
    ...
    return (
        <button onClick={signInWithGoogle} type="button" className="google-option">
